...
fluidDB.ajax = function(type, url, payload, callback, async_req, auth_token, mime){
    ...
    $.ajax({
          ...
          beforeSend: function(xhrObj){
              ...
              xhrObj.setRequestHeader("user-agent","javascriptFluidDB");
          },
          contentType: mime,
          type: type,
          url: url,
...
fluidDB.put = function(url, payload, callback, async_req, auth_token){
    fluidDB.ajax("PUT", fluidDB.baseURL+url, payload, callback, async_req, auth_token);
}
